...
| Lending | A demo-dollar lending market that takes USTX as collateral at the recorded NAV, with a jump-rate curve and liquidations that the fund's redemption at NAV pays out; tested, run against the live contracts on a local fork, deployed and activated on X Layer Testnet, with a Borrow section on the USTX page that deposits USTX, borrows, repays, withdraws and lends from OKX Wallet | `8706a43`, `97a2fee`, `0d989a7` |
...
From `7a33392` to `1eccd98`: 244 files changed, 25863 insertions(+), 7375 deletions(-).
...
| 2026-09-25 04:44 | `163f253` | Bring the build-period record up to the latest commit | 1 | +8 / −2 |
...
| 2026-09-25 07:19 | `26dc21c` | Regenerate the build-period commit list with best-price routing | 1 | +5 / −2 |
| 2026-09-25 07:19 | `7dafdcc` | Record the best-price routing release 5d7eebbc | 1 | +21 / −3 |
| 2026-09-25 08:09 | `0d989a7` | Activate the lending market and borrow against USTX from the USTX page | 23 | +877 / −44 |
| 2026-09-25 08:14 | `1eccd98` | Record the lending activation and release de3e16c9 | 1 | +24 / −3 |
