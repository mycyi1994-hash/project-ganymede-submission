...
- Source verification: all seven X Layer Testnet contracts are verified on the OKX explorer and match exactly on Sourcify, for example USTX at https://repo.sourcify.dev/1952/0x77eaeba1366bde7818da12d3cbdbea0a2ee97596
...
| USTX-collateral lending market, written and tested and run against the live contracts on a local fork (not deployed); all four contracts source-verified on the OKX explorer and Sourcify | `8706a43` |
